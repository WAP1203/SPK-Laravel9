            ...
            <div class="card-body">
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>{{$alternatif->kriteria_4 / $C4min['alternatif']}}</td>
                        <td>{{$alternatif->kriteria_5 / $C5min['alternatif']}}</td>
                    </tr>
                @endforeach
                </tbody>
                </table>
            ...
            <div class="card-body">
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        {{-- Hasil --}}
                        <td>
                            {{(($C1min['alternatif'] / $alternatif->kriteria_1 )*$widget1['kriteria'])+
                            (($alternatif->kriteria_2 / $C2max['alternatif'])*$widget2['kriteria'])+
                            (($alternatif->kriteria_3 / $C3max['alternatif'])*$widget3['kriteria'])+
                            (($alternatif->kriteria_4 / $C4min['alternatif'])*$widget4['kriteria'])+
                            (($alternatif->kriteria_5 / $C5min['alternatif'])*$widget5['kriteria'])}}
                        </td>
                    </tr>
                @endforeach
                </tbody>
